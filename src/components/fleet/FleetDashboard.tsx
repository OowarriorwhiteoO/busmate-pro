...
const mockBuses: BusData[] = [
  {
    ...
    defectos: 'Problema menor en sistema de frenos resuelto en mantenimiento.',
  ...
  },
  {
    ...
    calefaccion: 'Si',
    aireAcondicionado: 'Si',
    defectos: 'Ningún defecto registrado.',
  },
  {
    id: '3',
    ppu: 'GHI-789',
    ...
    calefaccion: 'No',
    aireAcondicionado: 'Si',
    defectos: 'Falla en sistema eléctrico menor, reparada.',
